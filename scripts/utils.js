 ...
 * 
 * @param {chrome.declarativeNetRequest.Rule} rule The rule object to check for a duplicate of.
 ...
 * 
 * @param {chrome.declarativeNetRequest.Rule[]} ruleList The locally-stored list of rules.
